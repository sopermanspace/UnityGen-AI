...
public class CoderAI {
    ...
    public CoderAI(string apiKey) {
        this.apiKey = apiKey;
    }

   public void SendCodeRequest(string prompt, int maxTokens, float temperature, System.Action<string> onResponse) 
    {
        ...
        string requestBody = "{\"model\":\"text-davinci-003\", \"prompt\":\"" + prompt + "\", \"max_tokens\":" + maxTokens + ", \"temperature\":" + temperature + "}";
